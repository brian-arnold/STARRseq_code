...
INPUT_DNA=${BASEDIR}/BAMs_sorted/Amel-${BIOREP}-input_csorted.bam
NAME=/Genomics/kocherlab/bjarnold/STARRseq/data/MACS2_raw_input_deduped_output/${LIBRARY}-${BIOREP}
GSIZE=223937270
